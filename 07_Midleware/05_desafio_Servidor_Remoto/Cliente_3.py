...
import os
import Pyro5.api
import psutil  # Biblioteca para monitoramento de recursos do sistema

def obter_memoria_atual() -> float:
    """Retorna o uso de memória do processo atual em Megabytes (MB)."""
    processo = psutil.Process(os.getpid())
    # rss = Resident Set Size (memória RAM real alocada pelo processo)
...
def executar_cliente_secundario(id_cliente="Cliente-Beta"):
    ...
    try:
        ...
        # Captura métricas finais após a execução (mesmo em caso de falha)
